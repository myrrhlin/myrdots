...
# Takes one optional argument to specify which sandbox (e.g. 01, 02, etc.) to which to connect
# e.g. `ssh_sandbox` goes to sandbox-$USER-01
ssh_sandbox() {
  ssh -A sandbox-$USER-${1:-01}.legacy-dev-uw2.zipaws.com
}
